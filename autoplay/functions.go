...
// if cell has 0 neighbors, automatically opens its neighbors, recursive process
...
// returns coordinates (row,column) of left top and right bottom neghbors, depending on situation may return itself as neighbor
